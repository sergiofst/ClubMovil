...
Public Class ContenidoDAO
    ...
    Public Function ListContenido() As DataSet
        Dim cmd As DbCommand = GetSqlStringCommand("SELECT IdContenido, IdTipoContenido, Nombre, Descripcion, Imagen, Orden, Visible, Estatus FROM Contenido WHERE Estatus=@Estatus AND Visible=@Visible")
    ...
    Public Function ListContenidoByCategoria(ByVal idCategoria As Integer) As DataSet
        ...
        With query
            .Append("SELECT A.IdContenido, A.IdTipoContenido, A.Nombre, A.Descripcion, A.Imagen, A.Orden, A.Visible, B.IdCategoria ")
    ...
    Public Function GetContenido(ByVal idContenido As Integer) As DataRow
        Dim cmd As DbCommand = GetSqlStringCommand("SELECT IdContenido, IdTipoContenido, Nombre, Descripcion, Imagen, Orden, Visible, Estatus FROM Contenido WHERE IdContenido=@IdContenido")
    ...
    Public Function ListContenidoClaves(ByVal idContenido As Integer) As DataSet
        Dim cmd As DbCommand = GetSqlStringCommand("SELECT IdContenidoClave,IdContenido,Clave FROM Contenido_Clave WHERE IdContenido=@IdContenido AND Estatus=@Estatus")
        AddInParameter(cmd, "@IdContenido", DbType.Int32, idContenido)
        AddInParameter(cmd, "@Estatus", DbType.Boolean, True)
        Return ExecuteDataSet(cmd)
    End Function
    ...
    Public Function AddContenidoClave(ByVal idContenido As Integer, ByVal clave As String) As Integer
        Dim cmd As DbCommand = GetSqlStringCommand("INSERT INTO Contenido_Clave (IdContenido,Clave,Estatus) VALUES (@IdContenido,@Clave,@Estatus)")
        AddInParameter(cmd, "@IdContenido", DbType.Int32, idContenido)
    ...
    Public Function DelContenidoClave(ByVal idContenidoClave As Integer) As Integer
        Dim cmd As DbCommand = GetSqlStringCommand("UPDATE Contenido_Clave SET Estatus=@Estatus WHERE IdContenidoClave=@IdContenidoClave")
    ...
    Public Function ListContenidoImagenes(ByVal idContenido As Integer) As DataSet
        Dim cmd As DbCommand = GetSqlStringCommand("SELECT IdContenidoImagen,IdContenido,FileName FROM Contenido_Imagen WHERE IdContenido=@IdContenido AND Estatus=@Estatus")
        AddInParameter(cmd, "@IdContenido", DbType.Int32, idContenido)
        AddInParameter(cmd, "@Estatus", DbType.Boolean, True)
        Return ExecuteDataSet(cmd)
    End Function
    ...
    Public Function AddContenidoImagen(ByVal idContenido As Integer, ByVal fileName As String) As Integer
        Dim cmd As DbCommand = GetSqlStringCommand("INSERT INTO Contenido_Imagen (IdContenido,FileName,Estatus) VALUES (@IdContenido,@FileName,@Estatus)")
        AddInParameter(cmd, "@IdContenido", DbType.Int32, idContenido)
    ...
    Public Function DelContenidoImagen(ByVal idContenidoImagen As Integer) As Integer
        Dim cmd As DbCommand = GetSqlStringCommand("UPDATE Contenido_Imagen SET Estatus=@Estatus WHERE IdContenidoImagen=@IdContenidoImagen")
    ...
    Public Function ListContenidoInfo(ByVal idContenido As Integer) As DataSet
        Dim cmd As DbCommand = GetSqlStringCommand("SELECT IdContenidoInfo, IdContenido, Etiqueta, Valor, Visible, Estatus FROM Contenido_Info WHERE IdContenido=@IdContenido AND Estatus=@Estatus")
        AddInParameter(cmd, "@IdContenido", DbType.Int32, idContenido)
        AddInParameter(cmd, "@Estatus", DbType.Boolean, True)
        Return ExecuteDataSet(cmd)
    End Function
    ...
    Public Function AddContenidoInfo(ByVal idContenido As Integer, ByVal etiqueta As String, ByVal valor As String) As Integer
        Dim cmd As DbCommand = GetSqlStringCommand("INSERT INTO Contenido_Info (IdContenido,Etiqueta,Valor,Estatus) VALUES (@IdContenido,@Etiqueta,@Valor,@Estatus)")
        AddInParameter(cmd, "@IdContenido", DbType.Int32, idContenido)
    ...
    Public Function DelContenidoInfo(ByVal idContenidoImagen As Integer) As Integer
        Dim cmd As DbCommand = GetSqlStringCommand("UPDATE Contenido_Info SET Estatus=@Estatus WHERE IdContenidoInfo=@IdContenidoInfo")
    ...
    Public Function ListContenidoCategorias(ByVal idContenido As Integer) As DataSet
        ...
        With query
            ...
            .Append("FROM Contenido_Categoria AS A INNER JOIN Categoria AS B ON (A.IdCategoria=B.IdCategoria AND B.Estatus=@Estatus) ")
    ...
    Public Function AddContenidoCategoria(ByVal idContenido As Integer, ByVal idCategoria As Integer) As Integer
        Dim cmd As DbCommand = GetSqlStringCommand("INSERT INTO Contenido_Categoria (IdContenido,IdCategoria,Estatus) VALUES (@IdContenido,@IdCategoria,@Estatus)")
        AddInParameter(cmd, "@IdContenido", DbType.Int32, idContenido)
        AddInParameter(cmd, "@IdCategoria", DbType.Int32, idCategoria)
        AddInParameter(cmd, "@Estatus", DbType.Boolean, True)
        Return ExecuteNonQueryIdentity(cmd)
    ...
    Public Function DelContenidoCategoria(ByVal idContenidoCategoria As Integer) As Integer
        Dim cmd As DbCommand = GetSqlStringCommand("UPDATE Contenido_Categoria SET Estatus=@Estatus WHERE IdContenidoCategoria=@IdContenidoCategoria")
    ...
    Public Function ExistContenidoCategoria(ByVal idContenido As Integer, ByVal idCategoria As Integer) As Boolean
        Dim cmd As DbCommand = GetSqlStringCommand("SELECT COUNT(IdContenidoCategoria) AS Count FROM Contenido_Categoria WHERE IdContenido=@IdContenido AND IdCategoria=@IdCategoria AND Estatus=@Estatus")
        AddInParameter(cmd, "@IdContenido", DbType.Int32, idContenido)
        AddInParameter(cmd, "@IdCategoria", DbType.Int32, idCategoria)
        AddInParameter(cmd, "@Estatus", DbType.Boolean, True)
